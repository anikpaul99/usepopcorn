...
/**
 * Show a loding message while data loading from api
 * @returns {JSX.Element}
 */
function Loader() {
...
/**
 * Each movie from searched results
 * @prop {Object} movie
 * @returns {JSX.Element}
 * @author Anik Paul
 */
...
/**
 * Will show the selected movie's details from searched result
 * @prop {string} selectedId the id of the selected movie from searched result
 * @returns {JSX.Element}
 * @author Anik Paul
 */
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  /**
   * will update watched movie state with a new watched movie object
   */
  function handleAdd() {
          ...
          <section>
            <div className="rating">
              {!isWatched ? (
                ...
                <p>You gave this movie a {watchedUserRating} 🌟</p>
              )}
            </div>
            <p>
              <em>{plot}</em>
